...
namespace RainyMemory {
    ...
    private:
        LRUCacheMemoryPool<leafNode, basicInfo> * leafPool; // storage [info] in leafPool
        LRUCacheMemoryPool<internalNode, int> * internalPool;
        basicInfo info;
    ...
    public:
        ...
        void rollback(int timeStamp) {
            leafPool->rollback(timeStamp);
            internalPool->rollback(timeStamp);
            info = leafPool->readExtraMessage();
        }
